...
public class AlertUtil {
    ...
    // Generic Confirmation (Resource ID Title)
    public static void showConfirmationDialog(Context context, int titleResId, String message, OnPositiveClickListener listener) {
    ...
    // Generic Confirmation (String Title)
